...
export default function CreatorAvailabilityCalendar({
  ...
  return (
    <div
      className={`rounded-2xl border border-[var(--kama-border)] bg-[var(--kama-surface)] ${
        compact ? "p-3" : "p-4"
      }`}
    >
      ...
      <div className="grid grid-cols-7 gap-1 text-center text-[10px] font-semibold uppercase tracking-wide text-[var(--kama-ink-muted)]">
        {WEEKDAYS.map((d) => (
      ...
      <div className="mt-3 flex flex-wrap gap-3 text-[10px] text-[var(--kama-ink-muted)]">
