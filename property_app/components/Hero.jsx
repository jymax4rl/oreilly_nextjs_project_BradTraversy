...
function Hero() {
  return (
    <div className="w-full md:h-[55vh] pt-0 md:pt-[8vh] relative bg-white md:bg-transparent">
      {/* Desktop only: hero photo + overlay */}
      ...
      {/* Desktop: glass card + decorative blobs */}
      <main className="hidden md:flex relative z-10 h-[55vh] flex-col items-center justify-center pb-32 px-4 w-full">
