...
export const POST = async (request) => {
  try {
    ...
    const existingTx = await Transaction.findOne({ transaction_id: body.transaction_id });
    if (existingTx) {
      return Response.json({ success: true, message: "Transaction already saved", transaction: existingTx });
    }
